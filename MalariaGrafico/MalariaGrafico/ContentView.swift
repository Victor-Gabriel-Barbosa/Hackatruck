...
struct ContentView: View {
    ...
    // Format: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023]
    ...
    // Estado para controlar visualização expandida em dispositivos móveis
        ...
        ScrollView {
            VStack {
                ...
                VStack(alignment: .leading) {
                    ...
                    // Botão para expandir/contrair em dispositivos móveis
                    Button(action: {
                        withAnimation {
                            isExpanded.toggle()
                        }
                    }) {
                        Text(isExpanded ? "Contrair gráfico" : "Expandir gráfico")
                            .font(.subheadline)
                            .padding(.vertical, 8)
                    ...
                    .frame(minHeight: isExpanded ? 700 : 500)
